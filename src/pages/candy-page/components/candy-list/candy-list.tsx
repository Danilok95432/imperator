...
import { CandyCard } from './components/candy-card/candy-card'
...
export const CandyList = () => {
	...
	const currentItems = data?.items
		...
		: mockCandies.slice(startIndex, endIndex)
	...
	}, [mockCandies, currentPage, ITEMS_PER_PAGE])
		...
		<Container className={styles.cont}>
			<div className={styles.grid}>
				{currentItems.length > 1 ? (
					currentItems.map((chocolate) => <CandyCard key={chocolate.id} candy={chocolate} />)
				) : (
